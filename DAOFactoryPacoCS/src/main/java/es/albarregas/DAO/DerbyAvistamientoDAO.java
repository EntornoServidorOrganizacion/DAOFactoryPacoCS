 ...
 * @author paco
 */
public class DerbyAvistamientoDAO implements IAvistamientosDAO{
    ...
    public ArrayList<Avistamientos> getAvistamientos() {
        ...
        try {
            PreparedStatement sentencia = (PreparedStatement) ConnectionFactory.getDerbyConnection().createStatement();
